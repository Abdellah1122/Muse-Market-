            ...
            modelBuilder.Entity("FananeenAPI.Models.Client", b =>
                {
                    ...
                    b.Property<int>("NbrCommisionListed")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FananeenAPI.Models.Commision", b =>
                {
                    ...
                    b.Property<int>("SousCategorieOeuvreId")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("WantedReturnDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("imageCommision")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("SousCategorieOeuvreId");
            ...
            modelBuilder.Entity("FananeenAPI.Models.Commision", b =>
                {
                    ...
                    b.HasOne("FananeenAPI.Models.SousCategorieOeuvre", "SousCategorieOeuvre")
                        .WithMany()
                        .HasForeignKey("SousCategorieOeuvreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Client");

                    b.Navigation("SousCategorieOeuvre");
                });
